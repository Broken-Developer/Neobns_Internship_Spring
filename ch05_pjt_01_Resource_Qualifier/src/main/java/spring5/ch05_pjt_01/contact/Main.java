package spring5.ch05_pjt_01.contact;

import org.springframework.context.support.GenericXmlApplicationContext;
import spring5.ch05_pjt_01.contact.service.ContactRegisterService;
import spring5.ch05_pjt_01.contact.service.ContactSearchService;
import spring5.ch05_pjt_01.contact.utils.InitSampleData;
...
public class Main {
    public static void main(String[] args) {
        ...
        ContactSet contactSet = searchService.search("류현진");
        System.out.println("name : " + contactSet.getName());
        System.out.println("phone number : " + contactSet.getPhoneNumber());
        System.out.println("------------------------");

        contactSet = searchService.search("손흥민");
        System.out.println("name : " + contactSet.getName());
        System.out.println("phone number : " + contactSet.getPhoneNumber());
        System.out.println("------------------------");

        contactSet = searchService.search("김연경");
        System.out.println("name : " + contactSet.getName());
        System.out.println("phone number : " + contactSet.getPhoneNumber());
        System.out.println("------------------------");
